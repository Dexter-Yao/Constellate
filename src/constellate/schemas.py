...
# ABOUTME: 定义结构化事件（可量化、支持数据分析）和非结构化事件的 Pydantic 模型
...
class GoalUpdateEvent(BaseEvent):
    """目标变更。"""
...
"""可量化的结构化事件，支持数据分析和趋势计算。"""

NonStructuredEventType = Union[
    GoalUpdateEvent,
    AppActionEvent,
]
"""非结构化事件，用于上下文理解和定性分析。"""
